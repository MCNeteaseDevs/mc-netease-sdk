...
- 参数
    ...
    | itemDict | dict | 玩家手持鱼竿的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
    | itemList | list(dict) | 钓鱼获得的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a>列表（只读） |
...
- 参数
    ...
    | hookEntity | str | 鱼钩实体id |
    | itemDict | dict | 玩家手持鱼竿的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
    | itemList | list(dict) | 钓鱼获得的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a>列表，支持修改。修改后需将itemChange设置为True |
