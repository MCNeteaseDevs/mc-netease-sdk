...
| [PhysxTriggerClientEvent](物理.md#physxtriggerclientevent) | <span style="display:inline;color:#7575f9">客户端</span> | 给自定义刚体添加的触发器，与其他碰撞体或原版实体进入/离开触发器时触发。需要在触发器创建时使用PxEventMask.Client才会触发 |
| [PhysxTriggerServerEvent](物理.md#physxtriggerserverevent) | <span style="display:inline;color:#ff5555">服务端</span> | 给自定义刚体添加的触发器，与其他碰撞体或原版实体发生进入触发器/离开触发器时触发。需要在触发器创建时使用PxEventMask.Server才会触发 |
...
| [PlayerFishingAfterServerEvent](玩家.md#playerfishingafterserverevent) | <span style="display:inline;color:#ff5555">服务端</span> | 玩家钓鱼成功收杆后触发，在钓鱼掉落物生成后触发 |
| [PlayerFishingServerEvent](玩家.md#playerfishingserverevent) | <span style="display:inline;color:#ff5555">服务端</span> | 玩家钓鱼成功收杆时触发，在钓鱼掉落物生成前触发 |
...
| [PlayerStartFishingServerEvent](玩家.md#playerstartfishingserverevent) | <span style="display:inline;color:#ff5555">服务端</span> | 玩家开始钓鱼，生成鱼钩时在服务端触发 |
...
| [LiquidClippedClientEvent](物品.md#liquidclippedclientevent) | <span style="display:inline;color:#7575f9">客户端</span> | 玩家客户端点击流体时触发（支持原版流体与自定义流体） |
| [LiquidClippedServerEvent](物品.md#liquidclippedserverevent) | <span style="display:inline;color:#ff5555">服务端</span> | 玩家服务端点击流体时触发（支持原版流体与自定义流体） |
...
| [PlayerAddCustomContainerItemClientEvent](物品.md#playeraddcustomcontaineritemclientevent) | <span style="display:inline;color:#7575f9">客户端</span> | 玩家成功将物品添加到自定义容器时触发该事件 |
| [PlayerAddCustomContainerItemServerEvent](物品.md#playeraddcustomcontaineritemserverevent) | <span style="display:inline;color:#ff5555">服务端</span> | 玩家向自定义容器中添加物品成功后触发该事件。该事件不可取消，仅用于通知物品添加操作已完成。 |
...
| [PlayerRemoveCustomContainerItemClientEvent](物品.md#playerremovecustomcontaineritemclientevent) | <span style="display:inline;color:#7575f9">客户端</span> | 玩家成功从自定义容器中移除物品时触发该事件 |
| [PlayerRemoveCustomContainerItemServerEvent](物品.md#playerremovecustomcontaineritemserverevent) | <span style="display:inline;color:#ff5555">服务端</span> | 玩家从自定义容器中移除物品成功后触发该事件。该事件不可取消，仅用于通知物品移除操作已完成。 |
