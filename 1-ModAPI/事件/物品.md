...
- 参数
    ...
    | 参数名 | <div style="width: 4em">数据类型</div> | 说明 |
    | :--- | :--- | :--- |
    | beforeItemDict | dict | 操作前目标槽位的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
    | changedItemDict | dict | 实际添加的物品的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
    | afterItemDict | dict | 操作后目标槽位的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
...
- 参数
    ...
    | :--- | :--- | :--- |
    | beforeItemDict | dict | 操作前目标槽位的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
    | changedItemDict | dict | 实际移除的物品的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
    | afterItemDict | dict | 操作后目标槽位的<a href="../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典">物品信息字典</a> |
    | collectionName | str | 容器名称，对应容器json中"custom_description"字段 |
    | collectionType | str | 容器类型，目前仅支持netease_container和netease_ui_container |
    | collectionIndex | int | 容器槽位索引 |
