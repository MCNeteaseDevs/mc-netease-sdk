...
- 参数
    ...
    | amount | float | 修饰符的数值 |
    | operation | int | [AttributeModifierOperation枚举](../../枚举值/AttributeModifierOperation.md)，修饰符的运算方式 |
    | operand | int | [AttributeOperands枚举](../../枚举值/AttributeOperands.md)，修饰符作用的操作数 |
...
- 备注
    - 仅能用于[CreateClientEntityByTypeStr](../世界/实体管理.md#createcliententitybytypestr)接口创建的客户端实体。
