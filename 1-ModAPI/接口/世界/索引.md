...
| [GetEntitiesAroundForClientEntity](地图.md#getentitiesaroundforcliententity) | <span style="display:inline;color:#7575f9">客户端</span> | 获取区域内的客户端实体列表 |
...
| [GetEntitiesInSquareAreaForClientEntity](地图.md#getentitiesinsquareareaforcliententity) | <span style="display:inline;color:#7575f9">客户端</span> | 获取区域内的客户端实体列表 |
...
| [GetRecipeByRecipeId](配方.md#getrecipebyrecipeid) | <span style="display:inline;color:#ff5555">服务端</span> | 根据配方id查询配方内容。 |
| [GetRecipeByRecipeId](配方.md#getrecipebyrecipeid) | <span style="display:inline;color:#7575f9">客户端</span> | 根据配方id查询配方内容。 |
...
| [UseItemToEntity](行为.md#useitemtoentity) | <span style="display:inline;color:#ff5555">服务端</span> | 模拟对某个实体使用物品。 |
| [UseItemToPos](行为.md#useitemtopos) | <span style="display:inline;color:#ff5555">服务端</span> | 对某个方块使用指定物品。 |
