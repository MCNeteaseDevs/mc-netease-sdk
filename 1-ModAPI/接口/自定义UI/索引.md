...
| 接口 | <div style="width: 3em"></div> | 描述 |
| --- | --- | --- |
| [CloseSettingUI](通用设置.md#closesettingui) | <span style="display:inline;color:#7575f9">客户端</span> | 关闭模组信息界面 |
| [GetSettingInst](通用设置.md#getsettinginst) | <span style="display:inline;color:#7575f9">客户端</span> | 获取当前模组的通用设置实例 |
| [OpenSettingUI](通用设置.md#opensettingui) | <span style="display:inline;color:#7575f9">客户端</span> | 在模组信息界面中打开设置页面（此操作仅可访问本模组的配置选项） |
| [RegisterSettingInst](通用设置.md#registersettinginst) | <span style="display:inline;color:#7575f9">客户端</span> | 注册通用设置实例 |
